const t = function () {
  ...
  return t.prototype.then = function (e, r) {
    ...
    return this.o = function (t) {
      try {
        const i = t.v;
        1 & t.s ? n(o, 1, e ? e(i) : i) : r ? n(o, 1, r(i)) : n(o, 2, i);
      } catch (t) {
        n(o, 2, t);
      }
    }, o
...
function n(e, r, o) {
  if (!e.s) {
    if (o instanceof t) {
      if (!o.s) return void (o.o = n.bind(null, e, r));
      1 & r && (r = o.s), o = o.v;
    }
    if (o && o.then) return void o.then(n.bind(null, e, r), n.bind(null, e, 2));
    e.s = r, e.v = o;
    const i = e.o;
    i && i(e);
  }
...
var e = 0,
  r = "function" == typeof WeakMap ? WeakMap : function () {
    var t = "function" == typeof Symbol ? Symbol(0) : "__weak$" + ++e;
...
function i(t, n) {
  return o(t.openCursor(n), function (t) {
...
function p(e, r) {
  return r(function (r, o) {
    try {
      function u() {
        return h.set(e, f), l.set(e, void 0), {
          value: d,
          done: void 0 === f
        }
      }
      ...
      var f, v, d, p = function (e, r) {
        ...
        [function () {
          ...
          return Promise.resolve(function (t, n) {
            return i(t, a(n)).then(function (t) {
              return t[0]
            })
          }(o, c)).then(function (t) {
            d = f = t;
        ...
        [function () {
          ...
          return Promise.resolve(s(o, c)).then(function (t) {
            var n;
            v = (n = t)[1], d = void 0 === (f = n[0]) ? void 0 : [f, v];
          })
        }]
      ]);
      return Promise.resolve(p && p.then ? p.then(u) : u())
    } catch (t) {
...
function m(t, n) {
  var e = new d;
  return y.set(e, t), v.set(e, n), h.set(e, f), l.set(e, void 0), e
}
d.prototype.return = function () {
  ...
  var t = this,
    n = v.get(this);
  if (!n) return Promise.reject(new TypeError("Invalid this value"));
  var e, r = l.get(this);
  return e = void 0 !== r ? r.then(function () {
    return p(t, n)
  }) : p(this, n), l.set(this, e), e
...
var b = function (t, n, e) {
  try {
    return null === w.get(t) && function (t) {
      var n = g.get(t);
      w.set(t, new Promise(function (e, r) {
        var o = self.indexedDB.open(n, 1);
        o.onsuccess = function () {
          var i = o.result;
          (function (t, n, e) {
            if (1 !== t.objectStoreNames.length) return e(j(n)), !1;
            if (t.objectStoreNames[0] !== P) return e(j(n)), !1;
            var r = t.transaction(P, "readonly").objectStore(P);
            return !(r.autoIncrement || r.keyPath || r.indexNames.length) || (e(j(n)), !1)
          })(i, n, r) && (i.onclose = function () {
            w.set(t, null);
  ...
  k = function (t) {
    var n = "kv-storage:" + t;
    w.set(this, null), g.set(this, n), this.backingStore = {
      database: n,
      store: P,
      version: 1
    };
...
k.prototype.set = function (t, n) {
  try {
    return c(t), b(this, "readwrite", function (e, r) {
      return void 0 === n ? r.delete(t) : r.put(n, t), u(e)
    })
  } catch (t) {
    return Promise.reject(t)
  }
  ...
  try {
    return c(t), b(this, "readonly", function (n, e) {
      return o(e.get(t))
    })
  } catch (t) {
    return Promise.reject(t)
  ...
  try {
    return c(t), b(this, "readwrite", function (n, e) {
      return e.delete(t), u(n)
    })
  } catch (t) {
    return Promise.reject(t)
  }
  ...
  var t = this;
  return m("keys", function (n) {
    return b(t, "readonly", n)
  })
}, k.prototype.values = function () {
  var t = this;
  return m("values", function (n) {
    return b(t, "readonly", n)
  })
}, k.prototype.entries = function () {
  var t = this;
  return m("entries", function (n) {
    return b(t, "readonly", n)
  })
