    ...
    _vm.episodes
      ? _c("div", { staticClass: "mdc-select" }, [
            ...
            "select",
            {
              ...
              on: {
                change: function($event) {
                  ...
                  _vm.currentEpisodeID = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0];
                }
              }
            ...
            [
              ...
              _vm._l(_vm.episodes, function(episode) {
                return episode.isActive
                  ? _c(
                      "option",
                      { key: episode.id, domProps: { value: episode.id } },
                      [
                        _vm._v(
                          _vm._s(episode.episodeTitle || episode.episodeFull)
                        )
                      ]
                    )
                  : _vm._e()
          ...
          _c("label", { staticClass: "mdc-floating-label" }, [
            _vm._v(
              _vm._s(
                _vm.$store.getters["player/currentEpisode"].episodeTitle ||
                  _vm.$store.getters["player/currentEpisode"].episodeFull
              )
            )
          ]),
          _vm._v(" "),
...
__vue_render__._withStripped = true;
  ...
  var episodeList = normalizeComponent_1(
...
var script$1 = {
  ...
  watch: {
    async translations() {
      const preference = await S.get("translationPreference");

      if (!preference) {
        await S.set("translationPreference", {
          bySeries: new Map()
        });
      }
  ...
  methods: {
    async saveTranslationPreference() {
      ...
      await S.set("translationPreference", preference);
    },
  ...
  async mounted() {
    let preference = await S.get("translationPreference");
...
var __vue_render__$1 = function() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _vm.translations && _vm.translations.length
    ? _c("section", { staticClass: "translation-list" }, [
        _c(
          "select",
          {
            directives: [
          ...
          _vm._l(_vm.filters.type.options, function(option) {
            return _c(
              "option",
            ...
            on: {
              change: [
                function($event) {
                  ...
                  _vm.currentTranslationID = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0];
                },
                _vm.saveTranslationPreference
              ]
            }
          },
          [
            !_vm.filteredTranslations || !_vm.filteredTranslations.length
            ...
            _vm._l(_vm.filteredTranslations, function(translation) {
              return translation.isActive
                ? _c(
                    ...
                    {
                      key: translation.id,
                      domProps: { value: translation.id }
                    },
                    [
                      _vm._v(
                        _vm._s(translation.authorsSummary || "Неизвестный")
                      )
                    ]
                  )
                : _vm._e()
...
__vue_render__$1._withStripped = true;
  ...
  var translationList = normalizeComponent_1(
...
__vue_render__$2._withStripped = true;
  ...
  var player$1 = normalizeComponent_1(
        ...
        ? [
            _c(
              ...
              [
                _c("episode-list"),
                _vm._v(" "),
                _vm.translations && _vm.translations.length
                  ? _c("translation-list")
                  : _vm._e()
              ],
              1
